...
//[[ogh: SHARE interface
/* These variables can be set for SHARE interface. */
static int		innobase_use_share      = 0;    // whether to use SHARE or not
static char*    innobase_share_device   = NULL;     // device supporting SHARE interface
static int      innobase_share_max      = 250;      // max # of lpn paris to use SHARE   
//]]ogh
...
mem_free_and_error:
    ...
    //[[ogh: SHARE interface
    srv_use_share = (int) innobase_use_share;
    srv_share_device = innobase_share_device;
    srv_share_max = (int)innobase_share_max;
    //]]ogh
...
//[[ogh: SHARE interface
static MYSQL_SYSVAR_INT(use_share, innobase_use_share,
    PLUGIN_VAR_RQCMDARG | PLUGIN_VAR_READONLY,
    "Enable SHARE interface (disabled by default).",
    NULL, NULL, 0, 0, 3, 0);
static MYSQL_SYSVAR_STR(share_device, innobase_share_device,
    PLUGIN_VAR_READONLY,
    "Path to special device supporting SHARE interface. ### ONLY FOR EXPERTS !!!! ###",
    NULL, NULL, NULL);
static MYSQL_SYSVAR_INT(share_max, innobase_share_max,
    PLUGIN_VAR_RQCMDARG | PLUGIN_VAR_READONLY,
    "The max # of lpn pairs to use SHARE interface.",
    NULL, NULL, 250, 1, 511, 0);
//]]ogh
...
static struct st_mysql_sys_var* innobase_system_variables[]= {
  ...
  //[[ogh: SHARE interface
  MYSQL_SYSVAR(use_share),
  MYSQL_SYSVAR(share_device),
  MYSQL_SYSVAR(share_max),
  //]]ogh
