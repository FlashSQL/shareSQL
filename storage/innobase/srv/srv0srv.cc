...
//[[ogh: SHARE interface
UNIV_INTERN int 	srv_use_share = 0;
UNIV_INTERN char*   srv_share_device = NULL;
UNIV_INTERN int 	srv_share_max = 250;
//]]ogh
				...
				the list of active transactions */
{
    ...
    if (srv_use_share) {
        fputs("----------------------\n"
              "SHARE interface STATUS\n"
              "----------------------\n", file);
        fprintf(file, "Use SHARE interface \n"
                        "SHARE device: %s\n"
                        "Max # of lpn pairs: %d\n",
                        srv_share_device,
                        srv_share_max);
